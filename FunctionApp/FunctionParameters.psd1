@{
    ...
    _MaxSimultaneousDeployments                   = @{Required = $false ; Type = 'int   '  ; Default = 25                                ; Description = 'Deprecated.This allows multiple deployments running simultaneously. Might change later to control maximum number of VMNames to deploy. Or control it using batches in template, or both!.' }
